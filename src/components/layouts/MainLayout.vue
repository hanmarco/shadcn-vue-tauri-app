...
<template>
    <div class="app-shell flex h-screen w-full overflow-hidden bg-background">
        <!-- Sidebar -->
        <Sidebar>
            <SidebarHeader
                class="border-b px-6 py-4 flex flex-row items-center justify-between"
            >
                    ...
                    <Tooltip>
                        ...
                        <TooltipContent side="right" :side-offset="10">
                            <div class="flex flex-col gap-1">
                                <span
                                    class="text-[10px] font-bold opacity-70 uppercase tracking-tighter"
                                    >Last Connected</span
                                >
                                <span
                                    class="font-mono text-[11px] leading-tight"
                                    >{{
                                        serialStore.lastConnectedDevice ||
                                        "Empty"
                                    }}</span
                                >
                            </div>
            ...
            <SidebarContent class="py-4">
                <div class="px-3 py-2">
                    <h3
                        class="mb-4 px-4 text-xs font-semibold uppercase tracking-wider text-muted-foreground/70"
                    >
                        Navigation
                    </h3>
                    <div class="space-y-1">
            ...
            <SidebarFooter class="space-y-3">
                <!-- Dark Mode Toggle -->
                <div
                    class="flex items-center justify-between px-2 py-2 rounded-md hover:bg-muted/30 transition-colors"
                >
                    <div class="flex items-center gap-2">
                        <div
                            class="flex h-7 w-7 items-center justify-center rounded-md bg-muted/60"
                        >
                            <SunIcon
                                v-if="!isDark"
                ...
                <!-- Simulation Toggle -->
                <div
                    class="flex items-center justify-between px-2 py-2 rounded-md bg-primary/5 border border-primary/10"
                >
                    <div class="flex items-center gap-2">
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                <path d="m3 18 5.9-5.9" />
                                <circle cx="12" cy="12" r="2" />
                                <path d="m15.1 8.9 5.9-5.9" />
                                <path d="m18 3 3 3" />
                                <path
                                    d="M21 21a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"
                                />
                            </svg>
                        </div>
                        <div class="flex flex-col">
                            ...
                            >
                            <span
                                class="text-[8px] text-muted-foreground italic leading-none"
                                >VIRTUAL CORE</span
                            >
                        </div>
                    </div>
